...
\begin{itemize}
    ...
    \item Republican Party, with 230 or more representatives. Probability=\Sexpr{p3}\%
    \item Republican Party, with less than 230 representatives. Probability=\Sexpr{p4}\%
  \end{itemize}
